...
echo
echo $pur"==================="$cy" ============================="
echo $i""$pu"  AUTHOR  :  Falasahmada"$i"                    "
echo $i""$pu"  WhatsApp:  Gaada Zeyeng"$i"                "
echo $i""$pu"  GMAIL   :  KochengOren@gmail.com"$i"     "
echo $i""$pu"  YOUTUBE :  Vx Channel"$i"                 "
echo $pur"==================="$cy" ============================="
echo
...
sleep 2
echo $pur"SUBSCRIBE MY CHANNEL { Vx Channel }"
exit
fi